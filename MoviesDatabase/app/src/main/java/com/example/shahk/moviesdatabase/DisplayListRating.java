...
public class DisplayListRating extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        final ArrayList<Movie> a = (ArrayList<Movie>) i.getSerializableExtra("ab");
        ln=a.size()-1;
        ...
        Collections.sort(a, new Comparator<Movie>() {
            ...
            public int compare(Movie o1, Movie o2) {
                return Integer.valueOf(o2.rating).compareTo(o1.rating);
            }
        });
        ...
        p.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    t++;
                    Toast.makeText(DisplayListRating.this,"Showing first Movie ",Toast.LENGTH_LONG).show();
                }
            }
        });
        nx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    t--;
                    Toast.makeText(DisplayListRating.this,"Showing Last Movie",Toast.LENGTH_LONG).show();
